...
/**
 * LegacyDashboard — the ORIGINAL SENTINEL XDR dashboard, preserved unchanged.
 * This is the exact UI that previously lived in app/page.tsx. It is rendered by
 * the /legacy route (always) and by / when NEXT_PUBLIC_UI_VERSION !== "new".
 * Do not redesign this file — it is the guaranteed legacy escape hatch.
 */
